package productions.darthplagueis.testinggooglemapsapi;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            address = coder.getFromLocationName("298 Whitman Drive, Brooklyn, NY 11235", 5);
            if (address != null) {
                Address location = address.get(0);
                p1 = new LatLng(location.getLatitude(), location.getLongitude());
                mMap.addMarker(new MarkerOptions().position(p1).title("Marker in Astoria - Neptune Diner")
                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.darth_vader_circle_crop)));
            }
